    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        <div className='flex flex-col items-center gap-3'>
          ...
          <p className="text-zinc-300 text-lg">Convide seus amigos e paneje sua próxima viagem!</p>
        </div>
        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            {isGuestsInputOpen ? (
              <button onClick={closeGuestsInput} className="bg-zinc-800 text-zinc-2000 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-zinc-700">Alterar Local/ Data
          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(emails => {
                return (
                  <div key={emails} className='py-1.5 px-1.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                    <span className='text-zinc-300'>{emails}</span>
                    <button onClick={() => removeEmailFromInvites(emails)} type='button'>
